...
public class Transacao {
	...
	public String toString() {
		return "Transacao [valorReal=" + valorReal + ", valorBitcoin=" + valorBitcoin + ", cotacaoTransacao="
				+ cotacaoTransacao + ", tipoTransacao=" + tipoTransacao + ", dataHoraTransacao=" + dataHoraTransacao
				+ "]";
	}
